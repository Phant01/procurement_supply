...
<div class="card" style="max-width:640px"><div class="card-header"><strong>Edit Item</strong></div>
<div class="card-body"><form method="post">
  <?php include ROOT_PATH . '/views/partials/_item_form.php'; ?>
  <button class="btn btn-primary"><i class="bi bi-save me-1"></i>Update Item</button>
</form></div></div>
